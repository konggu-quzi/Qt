...
#include "../../ExtensionDlg/extensiondlg.h"
...
struct qt_meta_stringdata_ExtensionDlg_t {
    QByteArrayData data[3];
    char stringdata0[29];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ExtensionDlg_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ExtensionDlg_t qt_meta_stringdata_ExtensionDlg = {
    {
QT_MOC_LITERAL(0, 0, 12), // "ExtensionDlg"
QT_MOC_LITERAL(1, 13, 14), // "showDetailInfo"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "ExtensionDlg\0showDetailInfo\0"
};
...
const QMetaObject ExtensionDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ExtensionDlg.data,
      qt_meta_data_ExtensionDlg,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ExtensionDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ExtensionDlg.stringdata0))
