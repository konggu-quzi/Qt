...
void DigiClock::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DigiClock *_t = static_cast<DigiClock *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject DigiClock::staticMetaObject = {
    { &QLCDNumber::staticMetaObject, qt_meta_stringdata_DigiClock.data,
      qt_meta_data_DigiClock,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
