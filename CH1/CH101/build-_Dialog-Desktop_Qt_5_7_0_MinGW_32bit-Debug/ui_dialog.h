...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        radiusLineEdit->setGeometry(QRect(100, 100, 113, 21));
        countBtn = new QPushButton(Dialog);
        countBtn->setObjectName(QStringLiteral("countBtn"));
        countBtn->setGeometry(QRect(360, 170, 93, 28));
